...
calcOrb = (rasstkm*1000 + 1737100)/r0 #400*2**3км
print(calcOrb)

tempPars = [0.001, 50.31940429687504, -0.569375, 8.61267578125002, 2.14678798379894]
tempPars = [0.001, 50.316798095703135, -0.5670703125000086, 8.988027343750106, 2.1947372025489407] #- идем к 400*2**3км
tempPars = [0.001, 50.32998016357378, -0.5701025390625051, 4.365800781250075, 2.3835164994239535]
